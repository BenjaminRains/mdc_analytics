-- opendental_analytics_opendentalbackup_01_03_2025.`statement` definition
...
CREATE TABLE `statement` (
  ...
  KEY `IsSent` (`IsSent`)
) ENGINE=MyISAM AUTO_INCREMENT=48809 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;