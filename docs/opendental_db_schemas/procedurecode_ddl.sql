-- opendental_analytics_opendentalbackup_01_03_2025.procedurecode definition
...
CREATE TABLE `procedurecode` (
  ...
  `IsTaxed` tinyint(3) unsigned NOT NULL,
  `PaintType` tinyint(4) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=1714 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;