-- opendental_analytics_opendentalbackup_01_03_2025.appointment definition
...
CREATE TABLE `appointment` (
  ...
  KEY `idx_appointment_aptdatetime` (`AptDateTime`),
  KEY `idx_appointment_patnum` (`PatNum`),
  KEY `idx_appt_datetime` (`AptDateTime`,`PatNum`),
  KEY `idx_appt_patient_status` (`PatNum`,`AptStatus`,`AptDateTime`),
  KEY `idx_appt_patient_date` (`PatNum`,`AptDateTime`,`AptStatus`)
) ENGINE=MyISAM AUTO_INCREMENT=195877 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;