-- opendental_analytics_opendentalbackup_01_03_2025.procedurelog definition
...
CREATE TABLE `procedurelog` (
  ...
  `MedicalCode` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT '',
  `DiagnosticCode` varchar(255) DEFAULT '',
  `IsPrincDiag` tinyint(3) unsigned NOT NULL,
  ...
  KEY `idx_procedurelog_patnum` (`PatNum`),
  KEY `idx_procedurelog_procnum` (`ProcNum`),
  KEY `idx_proc_date` (`ProcDate`,`ProcStatus`),
  KEY `idx_proc_patient` (`PatNum`,`ProcDate`),
  KEY `idx_proc_code` (`CodeNum`),
  KEY `idx_proc_patient_date` (`PatNum`,`ProcDate`,`ProcStatus`),
  KEY `idx_proc_guarantor_date` (`PatNum`,`ProcDate`,`ProcStatus`),
  KEY `idx_proc_payment` (`ProcNum`,`ProcFee`,`ProcStatus`),
  KEY `idx_proc_code_fee` (`CodeNum`,`ProcFee`,`ProcStatus`),
  KEY `idx_proc_date_status` (`ProcDate`,`ProcStatus`,`ProcFee`),
  KEY `idx_proc_patient_history` (`PatNum`,`ProcStatus`,`ProcDate`,`ProcFee`)
) ENGINE=MyISAM AUTO_INCREMENT=1142077 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;