-- opendental_analytics_opendentalbackup_01_03_2025.payplan definition

CREATE TABLE `payplan` (
  `PayPlanNum` bigint(20) NOT NULL AUTO_INCREMENT,
  `PatNum` bigint(20) NOT NULL,
  `Guarantor` bigint(20) NOT NULL,
  `PayPlanDate` date NOT NULL DEFAULT '0001-01-01',
...
) ENGINE=MyISAM AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;