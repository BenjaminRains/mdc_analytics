...
def export_data():
    """
    Main function to export data based on the 'procedurelog_query'.
    """
    try:
        # Retrieve file path for procedurelog_query export using the helper function
        output_path = get_file_path("procedurelog_query")
        if not output_path:
            raise KeyError("File path for 'procedurelog_query' is missing in file_paths.py")
        ...
        query = get_sql_query("procedurelog_query")
