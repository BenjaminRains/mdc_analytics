...
try:
    # Retrieve file path for perioexammeasure export using the helper function
    output_path = get_file_path("perioexammeasure")
    if not output_path:
        raise KeyError("File path for 'perioexammeasure' is missing in file_paths.py")
