...
def export_data():
    """
    Main function to export data based on the 'paysplit_query'.
    """
    try:
        # Retrieve file path for paysplit_query export using the helper function
        output_path = get_file_path("paysplit_query")
        if not output_path:
            raise KeyError("File path for 'paysplit_query' is missing in file_paths.py")
        ...
        query = get_sql_query("paysplit_query")
