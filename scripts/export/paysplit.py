...
try:
    # Retrieve file path for paysplit export using the helper function
    output_path = get_file_path("paysplit")
    if not output_path:
        raise KeyError("File path for 'paysplit' is missing in file_paths.py")
