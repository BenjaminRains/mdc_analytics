...
try:
    # Retrieve file path for proctp export using the helper function
    output_path = get_file_path("proctp")
    if not output_path:
        raise KeyError("File path for 'proctp' is missing in file_paths.py")
