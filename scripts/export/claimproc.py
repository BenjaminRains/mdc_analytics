...
try:
    # Retrieve file path for claimproc export using the helper function
    output_path = get_file_path("claimproc")
    if not output_path:
        raise KeyError("File path for 'claimproc' is missing in file_paths.py")
