...
try:
    # Retrieve file path for payment export using the helper function
    output_path = get_file_path("payment")
    if not output_path:
        raise KeyError("File path for 'payment' is missing in file_paths.py")
