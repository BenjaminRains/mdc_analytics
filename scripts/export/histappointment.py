...
def export_data():
    """
    Main function to export data based on the 'histappointment_query'.
    """
    try:
        # Retrieve file path for histappointment_query export using the helper function
        output_path = get_file_path("histappointment_query")
        if not output_path:
            raise KeyError("File path for 'histappointment_query' is missing in file_paths.py")
        ...
        query = get_sql_query("histappointment_query")
