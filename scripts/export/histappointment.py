...
try:
    # Retrieve file path for histappointment export using the helper function
    output_path = get_file_path("histappointment")
    if not output_path:
        raise KeyError("File path for 'histappointment' is missing in file_paths.py")
