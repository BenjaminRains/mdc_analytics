...
try:
    # Retrieve file path for treatplan export using the helper function
    output_path = get_file_path("treatplan")
    if not output_path:
        raise KeyError("File path for 'treatplan' is missing in file_paths.py")
