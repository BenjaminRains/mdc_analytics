...
try:
    # Retrieve file path for claimpayment export using the helper function
    output_path = get_file_path("claimpayment")
    if not output_path:
        raise KeyError("File path for 'claimpayment' is missing in file_paths.py")
