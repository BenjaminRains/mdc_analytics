...
def export_data():
    """
    Main function to export data based on the 'claimpayment_query'.
    """
    try:
        # Retrieve file path for claimpayment_query export using the helper function
        output_path = get_file_path("claimpayment_query")
        if not output_path:
            raise KeyError("File path for 'claimpayment_query' is missing in file_paths.py")
        ...
        query = get_sql_query("claimpayment_query")
