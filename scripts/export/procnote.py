...
try:
    # Retrieve file path for procnote export using the helper function
    output_path = get_file_path("procnote")
    if not output_path:
        raise KeyError("File path for 'procnote' is missing in file_paths.py")
