...
try:
    # Retrieve file path for procedurecode export using the helper function
    output_path = get_file_path("procedurecode")
    if not output_path:
        raise KeyError("File path for 'procedurecode' is missing in file_paths.py")
