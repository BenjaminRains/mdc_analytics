...
def export_data():
    """
    Main function to export data based on the 'procedurecode_query'.
    """
    try:
        # Retrieve file path for procedurecode_query export using the helper function
        output_path = get_file_path("procedurecode_query")
        if not output_path:
            raise KeyError("File path for 'procedurecode_query' is missing in file_paths.py")
        ...
        query = get_sql_query("procedurecode_query")
