...
try:
    # Retrieve file path for claim export using the helper function
    output_path = get_file_path("claim")
    if not output_path:
        raise KeyError("File path for 'claim' is missing in file_paths.py")
