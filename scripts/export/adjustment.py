...
try:
    # Retrieve file path for adjustment export using the helper function
    output_path = get_file_path("adjustment")
    if not output_path:
        raise KeyError("File path for 'adjustment' is missing in file_paths.py")
