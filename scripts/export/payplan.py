...
try:
    # Retrieve file path for payplan export using the helper function
    output_path = get_file_path("payplan")
    if not output_path:
        raise KeyError("File path for 'payplan' is missing in file_paths.py")
