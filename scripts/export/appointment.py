...
try:
    # Retrieve file path for appointment export using the helper function
    output_path = get_file_path("appointment")
    if not output_path:
        raise KeyError("File path for 'appointment' is missing in file_paths.py")
