...
def export_data():
    """
    Main function to export data based on the 'appointment_query'.
    """
    try:
        # Retrieve file path for appointment_query export using the helper function
        output_path = get_file_path("appointment_query")
        if not output_path:
            raise KeyError("File path for 'appointment_query' is missing in file_paths.py")
        ...
        query = get_sql_query("appointment_query")
