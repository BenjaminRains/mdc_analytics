{% include "pay_process_funnel.sql" %}
-- Payment processing health dashboard - displays key metrics and KPIs for monitoring payment data completeness and integrity
SELECT 
    base_count,
    with_splits,
    with_procedures,
