-- opendental_analytics_opendentalbackup_01_03_2025.payment definition
...
CREATE TABLE `payment` (
  ...
  `IsSplit` tinyint(3) unsigned NOT NULL DEFAULT 0,
  ...
  KEY `idx_payment_date` (`PayNum`,`PayDate`)
) ENGINE=MyISAM AUTO_INCREMENT=917437 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;