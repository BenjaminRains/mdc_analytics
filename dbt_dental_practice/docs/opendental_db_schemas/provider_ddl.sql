-- opendental_analytics_opendentalbackup_01_03_2025.provider definition
...
CREATE TABLE `provider` (
  ...
  `IsSecondary` tinyint(3) unsigned NOT NULL DEFAULT 0,
  ...
  `SigOnFile` tinyint(3) unsigned NOT NULL DEFAULT 1,
  ...
  KEY `IDX_TEMPPROVIDER_ABBR` (`Abbr`),
  KEY `FeeSched` (`FeeSched`)
) ENGINE=MyISAM AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;