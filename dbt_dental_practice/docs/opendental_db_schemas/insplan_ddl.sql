-- opendental_analytics_opendentalbackup_01_03_2025.insplan definition
...
CREATE TABLE `insplan` (
  ...
  `IsMedical` tinyint(3) unsigned NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=14602 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;